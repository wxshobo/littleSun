...
QT_MOC_LITERAL(1, 11, 10), // "addSuccess"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 18), // "closeButtonClicked"
QT_MOC_LITERAL(4, 42, 19) // "finishButtonClicked"

    },
    "AddProduct\0addSuccess\0\0closeButtonClicked\0"
    "finishButtonClicked"
};
...
void AddProduct::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddProduct::addSuccess)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AddProduct::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddProduct.data,
      qt_meta_data_AddProduct,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddProduct::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddProduct.stringdata0))
        return static_cast<void*>(const_cast< AddProduct*>(this));
